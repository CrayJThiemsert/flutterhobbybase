...
enum AppLogoStyle {
  ...
  ///
  /// This is the default behavior for [AppLogoDecoration] objects.
  markOnly,
...
class AppLogoDecoration extends Decoration {
...
//    this.darkColor = const Color(4292758044),
    ...
    this.margin = EdgeInsets.zero,
        ...
        assert(style != null),
        assert(margin != null),
        _position = identical(style, AppLogoStyle.markOnly) ? 0.0 : identical(style, AppLogoStyle.horizontal) ? 1.0 : -1.0,
  // (see https://github.com/dart-lang/sdk/issues/26980 for details about that ignore statement)
        _opacity = 1.0;

  const AppLogoDecoration._(this.lightColor, this.darkColor, this.textColor, this.style, this.margin, this._position, this._opacity);
  ...
  /// [AppLogoStyle.horizontal] or [AppLogoStyle.stacked]. The
  ...
  static AppLogoDecoration lerp(AppLogoDecoration a, AppLogoDecoration b, double t) {
    assert(t != null);
  ...
  @override
  AppLogoDecoration lerpFrom(Decoration a, double t) {
    assert(debugAssertIsValid());
    if (a == null || a is AppLogoDecoration) {
      assert(a == null || a.debugAssertIsValid());
      return AppLogoDecoration.lerp(a, this, t);
    }
    return super.lerpFrom(a, t);
  }

  @override
  AppLogoDecoration lerpTo(Decoration b, double t) {
    assert(debugAssertIsValid());
    if (b == null || b is AppLogoDecoration) {
      assert(b == null || b.debugAssertIsValid());
      return AppLogoDecoration.lerp(this, b, t);
    }
  ...
  bool operator ==(dynamic other) {
    ...
    if (identical(this, other))
      return true;
    if (other is! AppLogoDecoration)
      return false;
    final AppLogoDecoration typedOther = other;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<AppLogoStyle>('style', style));
    if (_inTransition)
...
class _FlutterLogoPainter extends BoxPainter {
  ...
  final AppLogoDecoration _config;
  ...
  ui.Image imageDq = null; //ui.Image.asset('assets/dq/dq01.png');
//  loadImage() async {
//    if (imageDq == null) {
//      imageDq = Image.asset('assets/dq/dq01.png');
////      this.markNeedsPaint();
//    }
//  }
...
//    canvas.drawRect(const Rect.fromLTWH(59.8, 123.1, 39.4, 39.4), mediumPaint);
    ...
    // ===================
    sky.Paint paint2 = sky.Paint()
      ..color = sky.Colors.black87
      ..style = PaintingStyle.stroke
      ..strokeWidth = 12;
    final radius = 80.0;
    sky.Offset point2 = sky.Offset(100.0, 100.0);
    canvas.drawCircle(point2, radius, paint2);

    sky.Paint paint = sky.Paint()..color = sky.Colors.red; // sky.Color.fromARGB(0xff, 0xff, 0xcd, 0x00);
    sky.Offset point = sky.Offset(120.9, 176.4);
    canvas.drawCircle(point, 20.0, paint);

    sky.Paint paint3 = sky.Paint()..color = sky.Colors.purple;
    sky.Offset point3 = sky.Offset(100.0, 100.0);
    canvas.drawCircle(point3, 60.0, paint3);
    // ===================
...
//    final ui.Gradient circleGradient = ui.Gradient.linear(
//      const Offset(62.3643 + 37.9092, 40.135 + 123.4389),
//      const Offset(54.0376 + 37.9092, 31.8083 + 123.4389),
//      <Color>[
//        const Color(0x80FFFFFF),
...
//    sky.ImageStreamListener listener(sky.ImageInfo frame, bool synchronousCall) {
